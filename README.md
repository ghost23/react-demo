...
After cloning this repo, navigate into the root folder of this project and
...
### Take the tour
This demo project has commentary, which is organized like a tour. The tour starts
at `public/index.html`. Within each file, look for the `TOUR` keyword.

### Notes on the setup of this project
...
- [react-helmet](https://github.com/nfl/react-helmet) (handling changes to document head)
